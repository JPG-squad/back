...
DEEPGRAM_API_KEY = secrets_manager.try_get_secret(secret_name, "deepgram_api_key")
# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = secrets_manager.try_get_secret(secret_name, "secret_key")
...
TRANSCRIPTION_REGION = os.environ.get("TRANSCRIPTION_REGION")
...
LOGGER_NAME = "backend"
logging_config_file = "logging.dev.ini"
